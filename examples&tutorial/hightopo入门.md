...
发送邮件至 `service@hightopo.com`, 将邮件标题指定为：申请试用
邮件内容正文使用如下格式：
----------------
称呼：
公司名称：
...
收到的压缩包`ht-for-web-版本号.zip`解压后目录文件结构如下：
```text
/lib 产品类库目录：
...
node.js环境搭建web服务，即可开发调试。
ht for web有很多令人惊叹的例子，请访问[demo官网](https://www.hightopo.com/demos/index.html)查看学习。
## 资料
文档中心：https://www.hightopo.com/guide2/index.html
HT API文档：http://www.hightopo.com/guide/doc/index.html
官方提供的学习内容已经足够，从入门到精通。
在某个demo的网址前面添加：https://hightopo.com/codeeditor/index.html?url=即可进入代码编辑器模式。
如：https://hightopo.com/guide/guide/core/beginners/examples/example_styleshape.html
